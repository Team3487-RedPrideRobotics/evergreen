...
public class TeleopCommand extends CommandBase {
    ...
    public void execute() {
        ...
        if(custom_toggle.getBoolean(true)){
            m_lights.setColors(new Color((float)custom_red.getDouble(1), (float)custom_green.getDouble(1), (float)custom_blue.getDouble(1)), Constants.LightBank);
        }else{
            if(alliance_chooser.getSelected() == "red"){
                m_lights.setColors(Constants.allianceRedColor, Constants.LightBank);
            }else{
                m_lights.setColors(Constants.allianceBlueColor, Constants.LightBank);
            }
        }
    }
